...
public class EnterpriseInfo {
    ...
    public Integer getAuditStatusInteger(){
        if(auditStatus != null ){
            return auditStatus.getValue();
        }
        return null;
    }
    public void setAuditStatusInteger(Integer auditStatusInteger){
        if(auditStatusInteger != null){
            this.auditStatus = AuditStatus.getItem(auditStatusInteger);
        }
    }
