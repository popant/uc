...
/**
 * <dl>
 * <dt>OnlineVideoHandler</dt>
 * <dd>Description:在线服务处理类</dd>
 ...
 * @author cy
 */
@Component("onlineVideoHandler")
public class OnlineVideoHandler implements ProductHandler {
	...
	private Short productId = 2;

	public OnlineVideoHandler(Short productId) {
		super();
	...
	/* (non-Javadoc)
	 * @see com.channelsoft.usercenter.business.factory.ProductHandler#openBusiness()
	 */
	@Override
...
//			UserInfo userInfo = getUserInfo();
	...
	/* (non-Javadoc)
	 * @see com.channelsoft.usercenter.business.factory.ProductHandler#initValue()
	 */
	@Override
