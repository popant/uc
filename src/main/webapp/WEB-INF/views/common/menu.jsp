...
<div class="page-sidebar-wrapper">
  ...
  <div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
      ...
      <%--<li data-bind="foreach:{ data: items,as:'menu'}">--%>
        <%--<a href="javascript:;">--%>
          <%--<i class="icon-home"></i>--%>
          <%--<span data-bind="text: menu.menuName" class="title"></span>--%>
          <%--&lt;%&ndash;<span class="selected"></span>&ndash;%&gt;--%>
          <%--<span class="arrow"></span>--%>
        <%--</a>--%>
        <%--<ul  class="sub-menu" >--%>
          <%--<li  data-bind="foreach:{ data: menu.subMenuList,as : 'subMenu'}">--%>
            <%--<a  data-bind="text:subMenu.menuName,click:$root.clickLeftMenu"></a>--%>
          <%--</li>--%>
        <%--</ul>--%>
      <%--</li>--%>
      <c:forEach var="menu" items="${sessionScope.menuList}">
        <li <c:if test="${sessionScope.currentParentId == menu.menuId}">class="start active open"</c:if> >
          <a href="javascript:;">
          ...
          <ul class="sub-menu">
            <c:forEach var="subMenu" items="${menu.subMenuList}">
              <li <c:if test="${sessionScope.currentMenuId == subMenu.menuId}"> class="active" </c:if>>
                <a href="${subMenu.menuHost}${subMenu.menuUrl}?currentParentId=${menu.menuId}&currentMenuId=${subMenu.menuId}">
                  <i class="${subMenu.menuClass}"></i>
                  ${subMenu.menuName}</a>
              </li>
            </c:forEach>
          </ul>
