                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input id="receiver" disabled="" type="text" class="form-control" value=${email}>
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-primary"
                                                    onclick="javascript:gotoUpdateEmail();">修改绑定
                                            </button> </span>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function gotoUpdateEmail(){
        window.location.href = '${pageContext.request.contextPath}/sendEmail/gotoUpdateEmail?receiver='+$('#receiver').val();
    }
</script>
