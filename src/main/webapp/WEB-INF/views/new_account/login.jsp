...
<div class="content">
  ...
  <form class="login-form" action="${pageContext.request.contextPath}/dologin" method="post">
    ...
    <div class="form-group">
      ...
      <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="手机号" name="userName"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-actions">
      ...
      <a href="${pageContext.request.contextPath}/forget" id="forget-password" class="forget-password">忘记密码?</a>
    </div>
    <div class="create-account">
      <p>
        <a href="${pageContext.request.contextPath}/register" id="register-btn" class="uppercase">注册用户</a>
      </p>
    </div>
  </form>
  <!-- END LOGIN FORM -->
