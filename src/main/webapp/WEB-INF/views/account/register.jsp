...
<div id="outer">  
    <div id="middle">  
        <div id="inner">  
             <div id="content">
				<div id="top"><img src="${pageContext.request.contextPath}/images/login-logo.jpg" width="100%" height="100px"></img></div>
				<div id="bottom" align="center">
					<div id="msg"><font color="red">${message}</font></div>
					<form id=loginform method=post name=loginform action="${pageContext.request.contextPath}/doregister">
						手机号:<input type=text id=userName name=userName class="input_border" maxlength=16/><br/>
						密码:<input type=password id=password name=password class="input_border"/><br/>
						确认密码:<input type=password id=comfirmPassword name=comfirmPassword class="input_border"/><br/>
						短信验证码:<input type=text id=valideCode name=valideCode class="input_border" value="a1bfc1" maxlength=16/><br/>
						验证码:<input type=text id=j_checkcode name=j_checkcode maxlength=4 style="width:85px;height:17px;"/>&nbsp;<a href="" onClick="document.getElementById('CheckPic').src='${pageContext.request.contextPath}/servlet/captchaCode?a='+Math.random()"><img  id="CheckPic" src="${pageContext.request.contextPath}/servlet/captchaCode" style="vertical-align:middle"/></a><br/>
