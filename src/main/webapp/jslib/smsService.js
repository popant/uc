var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = APPpath;
        if(name=='smsSignature'){
        	url = url + "/msgSignature/queryMsgSignature";
        }else if(name=='smsTemplate'){
        	url = url + "/msgtemplate/list";
        }else if(name=='forApiKey'){
        	url = url + "/msgSecretkey/queryMsgSecretkey";
        }else if(name=='sendRecord'){
        	url = url + "/msgSend/gotoMsgSendRecord";
        }else if(name=='sendStatistics'){
        	url = url + "/msgSend/gotoMsgSendStatistics";
        }
...
//            });
            ...
            $('.inbox-nav > li.smsSignature > a').click(function () {
                loadInbox($(this), 'smsSignature');
            });

            // handle sent listing
            $('.inbox-nav > li.smsTemplate > a').click(function () {
                loadInbox($(this), 'smsTemplate');
            });

            // handle draft listing
            $('.inbox-nav > li.forApiKey > a').click(function () {
                loadInbox($(this), 'forApiKey');
            });

            // handle trash listing
            $('.inbox-nav > li.sendRecord > a').click(function () {
                loadInbox($(this), 'sendRecord');
            });
            
            $('.inbox-nav > li.sendStatistics > a').click(function () {
                loadInbox($(this), 'sendStatistics');
            });
...
//            });
            ...
            if (Metronic.getURLParameter("a") === "view") {
               ...
               $('.inbox-nav > li.smsSignature > a').click();
            }
